console.log("hello") // developer based output , which is only shown on browser dev pannel
document.write("helloo") //user based output
alert('hii,I am an alert pannel') // when  website is loded

//varibale diclaration
var name;
//Initialization
name = "john";
...
//easy method to declare a variable and initialization
var name = "john doe";

//what is a variable ? why do we need a variable ?

//what is datatypes?
//how many data types are there is javascript?

//mainly two type of data types- : 1- Primitive and 2- refference datatypes
/* 
